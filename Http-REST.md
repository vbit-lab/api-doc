...
## 说明
    ...
    该API为Vbit(https://www.vbit.one)用于对外提供的 RESTfull API 接口文档说明.
    ...
    Vbit官方的生产环境:
        官网地址: https://www.vbit.one
        行情服务: https://cdn01.mcdzcloud.com/v1/rest
        交易服务: https://cdn01.mcdzcloud.com/v1/rest
...
```JavaScript
    // 请求
    http GET https://cdn01.mcdzcloud.com/v1/rest/Time
...
```JavaScript
    // 请求
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetAssetD
...
```JavaScript
    ...
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetCompositeIndex
...
```JavaScript
    ...
    http POST https://cdn01.mcdzcloud.com/v1/rest/GetHistKLine  Sym='BTC1812' Sec:=1541987816 Count:=2 Offset:=0 Typ='1m'
...
```JavaScript
     ...
     * Typ: K线的周期类型
     * */
    http POST https://cdn01.mcdzcloud.com/v1/rest/GetLatestKLine  Sym='BTC.USDT' Count:=2 Typ='1m'
...
```JavaScript
    ...
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetIndexTick?idx=CI_ETH
...
```JavaScript
    ...
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetTick?sym=BTC1812
...
```JavaScript
    ...
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetTrades?sym=BTC1812
...
```JavaScript
    ...
    http GET https://cdn01.mcdzcloud.com/v1/rest/GetOrd20?sym=BTC1812
...
http GET https://cdn01.mcdzcloud.com/v1/rest/GetIndexTickList?idx_list=CI_BTC,CI_ETH
http GET https://cdn01.mcdzcloud.com/v1/rest/GetTickList?sym_list=BTC.BTC,BTC.USDT,ETH.ETH,ETH.USDT
http GET https://cdn01.mcdzcloud.com/v1/rest/GetOrd20List?sym_list=BTC.BTC,BTC.USDT,ETH.ETH,ETH.USDT
...
```JavaScript
    ...
    echo '{"req":"GetUserInfo", "username":"XXX", "args":{}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544166435858, "signature":"7166be64f351c68318c835d4eb219cc3"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetCcsWallets", "username":"XXX", "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544166944189, "signature":"ac1234c94034566e7943217cd243259e"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetWallets", "username":"XXX", "args":{"AId":"102041501"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544166944189, "signature":"ac5fdac94088cb6e79d5ed7cd20eba9e"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetWalletsLog", "username":"XXX", "args":{"AId":"102041501"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544167142509, "signature":"b094142522364fab85ef82b8f875ca89"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetHistOrders", "username":"XXX", "args":{"AId":"102041501"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544167420498, "signature":"417377f8c05efdd8d6364dad48f70cb0"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    *  重要说明: 服务器会从用户的当前有效委托单以及最近500条历史委托中查找，没有则返回Code=404；过期的委托单就查不到了。
    ...
    echo '{"req":"GetOrderByID", "username":"XXX", "args":{"AId":"102041501", "OrdId":"01CXT69HBCWCGAQXSPK26G070N"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544167420498, "signature":"417377f8c05efdd8d6364dad48f70cb0"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetPositions", "username":"XXX", "args":{"AId":"102041501"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544167570475, "signature":"ea545fdf01aea172c2bbdce204a9186b"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"req":"GetOrders", "username":"XXX", "args":{"AId":"102041501"}, "apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw", "expires":1544167683629, "signature":"a0efd3adad53143b1fb09c06bbc02811"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"args":{"AId":"102041501","COrdId":"1544169579283102041501","Dir":1,"OType":1,"OrdFlag":0,"Prz":100,"PrzChg":1,"Qty":3000,"QtyDsp":0,"Sym":"BTC1812","Tif":0},"req":"OrderNew","expires":1544170179229,"signature":"5e6967d6b0715207243be37636d95c45","username":"XXX","apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"args":{"AId":"102041501","OrdId":"01CY1X0RRRK6G77QTMVDFB5FE7","Sym":"BTC1812"},"req":"OrderDel","expires":1544170922227,"signature":"607c940ca12c7fab55035c95a0e06c83","username":"XXX","apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"args":{"Sym":"BTC1812","AId":"102041501","PId":null,"Param":10},"req":"PosLeverage","expires":1544171021791,"signature":"5f8c60c9d6c572b06fb614465af3cac9","username":"XXX","apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"args":{"Sym":"BTC1812","AId":"102041501","PId":"01CXT69HBDZXF36MW2NHPBDG43","Param":500},"req":"PosTransMgn","expires":1544171208181,"signature":"07ebfaf6202dfa1d1f74cbfa5a5ebf83","username":"XXX","apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
```JavaScript
    ...
    echo '{"args":{"AId":"102041501","Sec":70},"req":"CancelAllAfter","expires":1544171689842,"signature":"b4b9f476392ca8ccffe41a66a045b825","username":"XXX","apikey":"bEwAA4NCzhexYsNtnyaYnhbMFQw"}' | http POST https://cdn01.mcdzcloud.com/v1/rest/Action
...
错误码在REST和WS两种API中定义是一致的，请参考 WebSocket_API_for_Vbit_v1.md 里的定义和说明。
