# VBIT WebSocket API (v1)

## 说明

目前 VBIT (https://www.vbit.one) 对于外提供 WebSocket API 开发接口， 供开发者获取行情数据和进行交易操作。
...
|指数|比如: index_VBIT_CI_BTC，index_VBIT_CI_ETH 订阅的综合指数推送频率为1000毫秒.|
 ...
 * 例:
 *  UserName: "example@vbit.com",
 *  UserCred: "mVAAADjNHzhvehaEvU$BMJoU7BZk"
 *  SecretKey: "uLgAAHMw62di3hUPypuETMWGzHx852swxM7V0b2HObba5gYNNrLkuvQ4I"
 *  Req: "Login"
 *  rid: 1
 * 根据上面的信息可以生成如下签名:
 * signature = md5("Login"+"1"+ JSON.stringify({UserName:"example@vbit.com",UserCred:"mVAAADjNHzhvehaEvU$BMJoU7BZk"}) +"1538222696758" + "uLgAAHMw62di3hUPypuETMWGzHx852swxM7V0b2HObba5gYNNrLkuvQ4I")
...
// 收到返回消息
{
    ...
    "data":[
        ...
        {"UId":"1234567","AId":"123456701","Coin":"ETH","Depo":5,"WDrw":0,"PNL":0,"Frz":0,"Status":2}
    ]
}
```
