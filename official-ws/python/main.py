...
from vbit_api_lib import VbitTradeWebsocket, VbitMarketWebsocket
from helper import my_json_marshal, my_json_unmarshal

from vbit_types import GT_Object, GT_Order, GT_Postion
...
def sample_main():
    cfg = {
        "prod" : {
            "trd_ws_url": consts.VBIT_PROD_TRADE_WEBSOCKET_URL,
            "mkt_ws_url": consts.VBIT_PROD_MARKET_WEBSOCKET_URL,
    ...
    env = 'prod'
    trd_ws = VbitTradeWebsocket(cfg[env]['trd_ws_url'],
                                cfg[env]['user_name'],
                                cfg[env]['api_key'],
                                cfg[env]['api_secret'],
    ...
    mkt_ws = VbitMarketWebsocket(cfg[env]['mkt_ws_url'],
