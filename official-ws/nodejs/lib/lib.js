...
server.prototype.init = function (options, cb) {
...
server.prototype.synctime = function (onPush) {
    var self = this;
    var tm = Date.now()
...
server.prototype.on = function (route,cb) {
    this.listeners[route] = cb;
}
server.prototype.remove = function (route) {
...
server.prototype.request = function (route,pmsg,cb) {
